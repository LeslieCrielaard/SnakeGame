...
{
    // @ts-ignore
    FilterContent(user: TestUser): TestUser{
...
{
    // @ts-ignore
    CheckUser(user: TestUser): TestUser{
...
{
    // @ts-ignore
    CheckLoginCredentials(user: TestUser): TestUser{
...
class Login{
private user: TestUser= new TestUser();
//In deze methode maak ik een nieuwe instantie aan van de bovengelegen klassen.
    checkUser(){
    let complexCredentialChecker: ComplexCredentialChecker = new ComplexCredentialChecker();
    let complexAuthorisationLogic: ComplexAuthorisationLogic = new ComplexAuthorisationLogic();
    let complexFilterLogic: ComplexFilterLogic = new ComplexFilterLogic();
